...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            type=str,
            default=['phash'],
            help='Specify hash algorithms to analyze (options: phash, ahash, dhash, whash). Default is phash.'
        )
    ...
    def handle(self, *args, **options):
        ...
        # Print the summary
        self.print_summary(direct_matches, hash_collisions, scaled_collisions, original_images_processed)
    ...
    def print_summary(self, direct_matches, hash_collisions, scaled_collisions, original_images_processed):
